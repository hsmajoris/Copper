...
FOOTNOTES = {
    "dxy": (
        ...
        "구간): 전 구간에서 부호가 한 번도 바뀌지 않고 -0.145~-0.480 사이에서 일관되게 역상관 "
        "(COPPER_TRADING_LOGIC.md 11장 참고)."
    ),
    "fxi": (
        ...
        "일간수익률 기준, 2년 단위 11개 구간): 전 구간에서 부호가 한 번도 바뀌지 않고 "
        "0.187~0.596 사이에서 일관되게 정상관. 원래 CHII(Global X MSCI China Industrials "
